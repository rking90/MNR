...
---
> **Important Info**
  >- Emails relating to the MNR that does not fall within any of the standard categories yet are still important to keep track of

>	**Issues to Resolve**
  >- Any emails regardless of category/company etc, requiring further information/clarification/amendments.  
...
> **Close-out Reports completed**
  >- Once the close-out report has been completed emails from the to-do folders are to be moved here.
...
---
  >- No internal folders to date
  >- No emails present to date

>### **MMO – Marine Management organisation**
---

> **MMO - MCMS**
  > **MMO MCMS - Not Recorded**
    >- Once MCMS have been determined to be unsuitable for uploading, the original email notification must be moved in to this folder
  > **MMO MCMS – Recorded**  
    >- Once MCMS have been recorded in to the MNR, the original email notification must be moved in to this folder
  > **MMO MCMS – To Do**
    >- Any emails received via the MMO Marine Case Management System that are yet to be uploaded.  

> **MMO - VolNot**  
  > **MMO - VolNots not recorded**   
    >- Once VolNots have been determined to be unsuitable for uploading, the original email notification must be moved in to this folder
  > **MMO - VolNots recorded**
    >- Once volnots have been recorded in to the MNR, the original email notification must be moved in to this folder
  > **MMO - VolNots to do**     
...
> **MoD - ASW
  ...
  > **MoD Recorded – Oct – Dec**
    >- Pre-prepared folder awaiting the new quarters proposed activity uploads for dates within the 1st of October to the 31st of December.
